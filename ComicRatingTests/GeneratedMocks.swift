// MARK: - Mocks generated from file: ComicRating/Modules/ComicHistory/Configurator/ComicHistoryInitializer.swift at 2020-08-28 15:13:56 +0000
 ...
 class MockComicHistoryModuleInitializer: ComicHistoryModuleInitializer, Cuckoo.ClassMock {
    ...
    return cuckoo_manager.call("awakeFromNib()",
	 ...
	 struct __StubbingProxy_ComicHistoryModuleInitializer: Cuckoo.StubbingProxy {
	    ...
	    var comicHistoryViewController: Cuckoo.ClassToBeStubbedOptionalProperty<MockComicHistoryModuleInitializer, ComicHistoryViewController> {
	    ...
	    func awakeFromNib() -> Cuckoo.ClassStubNoReturnFunction<()> {
	        ...
	        return .init(stub: cuckoo_manager.createStub(for: MockComicHistoryModuleInitializer.self, method: "awakeFromNib()", parameterMatchers: matchers))
	    }
	 ...
	 struct __VerificationProxy_ComicHistoryModuleInitializer: Cuckoo.VerificationProxy {
	    ...
	    var comicHistoryViewController: Cuckoo.VerifyOptionalProperty<ComicHistoryViewController> {
	        return .init(manager: cuckoo_manager, name: "comicHistoryViewController", callMatcher: callMatcher, sourceLocation: sourceLocation)
	    }
 ...
 class MockComicHistoryModuleBuilder: ComicHistoryModuleBuilder, Cuckoo.ClassMock {
    ...
    return cuckoo_manager.call("getViewController() -> ComicHistoryViewController?",
	 ...
	 struct __StubbingProxy_ComicHistoryModuleBuilder: Cuckoo.StubbingProxy {
	    ...
	    func getViewController() -> Cuckoo.ClassStubFunction<(), ComicHistoryViewController?> {
	        let matchers: [Cuckoo.ParameterMatcher<Void>] = []
	        return .init(stub: cuckoo_manager.createStub(for: MockComicHistoryModuleBuilder.self, method: "getViewController() -> ComicHistoryViewController?", parameterMatchers: matchers))
	    }
	 ...
	 struct __VerificationProxy_ComicHistoryModuleBuilder: Cuckoo.VerificationProxy {
	    ...
	    @discardableResult
	    func getViewController() -> Cuckoo.__DoNotUse<(), ComicHistoryViewController?> {
	        let matchers: [Cuckoo.ParameterMatcher<Void>] = []
...
// MARK: - Mocks generated from file: ComicRating/Modules/ComicHistory/Interactor/ComicHistoryInteractorInput.swift at 2020-08-28 15:13:56 +0000
 ...
 class MockComicHistoryInteractorInput: ComicHistoryInteractorInput, Cuckoo.ProtocolMock {
    ...
    return cuckoo_manager.call("fetchImage(fromUrl: URL, id: Int)",
	 ...
	 struct __StubbingProxy_ComicHistoryInteractorInput: Cuckoo.StubbingProxy {
	    ...
	    func getComics() -> Cuckoo.ProtocolStubNoReturnFunction<()> {
	        let matchers: [Cuckoo.ParameterMatcher<Void>] = []
	        return .init(stub: cuckoo_manager.createStub(for: MockComicHistoryInteractorInput.self, method: "getComics()", parameterMatchers: matchers))
	    }
	    
	    func fetchImage<M1: Cuckoo.Matchable, M2: Cuckoo.Matchable>(fromUrl url: M1, id: M2) -> Cuckoo.ProtocolStubNoReturnFunction<(URL, Int)> where M1.MatchedType == URL, M2.MatchedType == Int {
	        let matchers: [Cuckoo.ParameterMatcher<(URL, Int)>] = [wrap(matchable: url) { $0.0 }, wrap(matchable: id) { $0.1 }]
	        return .init(stub: cuckoo_manager.createStub(for: MockComicHistoryInteractorInput.self, method: "fetchImage(fromUrl: URL, id: Int)", parameterMatchers: matchers))
	    }
	 ...
	 struct __VerificationProxy_ComicHistoryInteractorInput: Cuckoo.VerificationProxy {
	    ...
	    @discardableResult
	    func getComics() -> Cuckoo.__DoNotUse<(), Void> {
	        let matchers: [Cuckoo.ParameterMatcher<Void>] = []
	        return cuckoo_manager.verify("getComics()", callMatcher: callMatcher, parameterMatchers: matchers, sourceLocation: sourceLocation)
	    }
	    
	    @discardableResult
	    func fetchImage<M1: Cuckoo.Matchable, M2: Cuckoo.Matchable>(fromUrl url: M1, id: M2) -> Cuckoo.__DoNotUse<(URL, Int), Void> where M1.MatchedType == URL, M2.MatchedType == Int {
	        let matchers: [Cuckoo.ParameterMatcher<(URL, Int)>] = [wrap(matchable: url) { $0.0 }, wrap(matchable: id) { $0.1 }]
...
// MARK: - Mocks generated from file: ComicRating/Modules/ComicHistory/Interactor/ComicHistoryInteractorOutput.swift at 2020-08-28 15:13:56 +0000
    ...
    return cuckoo_manager.call("imageFetchFailed(id: Int)",
	 ...
	 struct __StubbingProxy_ComicHistoryInteractorOutput: Cuckoo.StubbingProxy {
	    ...
	    func comicsLoaded<M1: Cuckoo.Matchable>(comics: M1) -> Cuckoo.ProtocolStubNoReturnFunction<([Comic])> where M1.MatchedType == [Comic] {
	        ...
	        return .init(stub: cuckoo_manager.createStub(for: MockComicHistoryInteractorOutput.self, method: "comicsLoaded(comics: [Comic])", parameterMatchers: matchers))
	    }
	    
	    func imageFetched<M1: Cuckoo.Matchable, M2: Cuckoo.Matchable>(imageData: M1, id: M2) -> Cuckoo.ProtocolStubNoReturnFunction<(Data, Int)> where M1.MatchedType == Data, M2.MatchedType == Int {
	        let matchers: [Cuckoo.ParameterMatcher<(Data, Int)>] = [wrap(matchable: imageData) { $0.0 }, wrap(matchable: id) { $0.1 }]
	        return .init(stub: cuckoo_manager.createStub(for: MockComicHistoryInteractorOutput.self, method: "imageFetched(imageData: Data, id: Int)", parameterMatchers: matchers))
	    }
	    ...
	    func imageFetchFailed<M1: Cuckoo.Matchable>(id: M1) -> Cuckoo.ProtocolStubNoReturnFunction<(Int)> where M1.MatchedType == Int {
	        ...
	        return .init(stub: cuckoo_manager.createStub(for: MockComicHistoryInteractorOutput.self, method: "imageFetchFailed(id: Int)", parameterMatchers: matchers))
	    }
	 ...
	 struct __VerificationProxy_ComicHistoryInteractorOutput: Cuckoo.VerificationProxy {
	    ...
	    @discardableResult
	    func imageFetched<M1: Cuckoo.Matchable, M2: Cuckoo.Matchable>(imageData: M1, id: M2) -> Cuckoo.__DoNotUse<(Data, Int), Void> where M1.MatchedType == Data, M2.MatchedType == Int {
	        let matchers: [Cuckoo.ParameterMatcher<(Data, Int)>] = [wrap(matchable: imageData) { $0.0 }, wrap(matchable: id) { $0.1 }]
...
// MARK: - Mocks generated from file: ComicRating/Modules/ComicHistory/View/ComicHistoryViewController.swift at 2020-08-28 15:13:56 +0000
    ...
    return cuckoo_manager.call("viewWillTransition(to: CGSize, with: UIViewControllerTransitionCoordinator)",
	 ...
	 struct __StubbingProxy_ComicHistoryViewController: Cuckoo.StubbingProxy {
	    ...
	    func viewDidLoad() -> Cuckoo.ClassStubNoReturnFunction<()> {
	        let matchers: [Cuckoo.ParameterMatcher<Void>] = []
	        return .init(stub: cuckoo_manager.createStub(for: MockComicHistoryViewController.self, method: "viewDidLoad()", parameterMatchers: matchers))
	    }
	    ...
	    func viewWillAppear<M1: Cuckoo.Matchable>(_ animated: M1) -> Cuckoo.ClassStubNoReturnFunction<(Bool)> where M1.MatchedType == Bool {
	        ...
	        return .init(stub: cuckoo_manager.createStub(for: MockComicHistoryViewController.self, method: "viewWillAppear(_: Bool)", parameterMatchers: matchers))
	    }
	    
	    func viewWillTransition<M1: Cuckoo.Matchable, M2: Cuckoo.Matchable>(to size: M1, with coordinator: M2) -> Cuckoo.ClassStubNoReturnFunction<(CGSize, UIViewControllerTransitionCoordinator)> where M1.MatchedType == CGSize, M2.MatchedType == UIViewControllerTransitionCoordinator {
	        let matchers: [Cuckoo.ParameterMatcher<(CGSize, UIViewControllerTransitionCoordinator)>] = [wrap(matchable: size) { $0.0 }, wrap(matchable: coordinator) { $0.1 }]
	        return .init(stub: cuckoo_manager.createStub(for: MockComicHistoryViewController.self, method: "viewWillTransition(to: CGSize, with: UIViewControllerTransitionCoordinator)", parameterMatchers: matchers))
	    }
	 ...
	 struct __VerificationProxy_ComicHistoryViewController: Cuckoo.VerificationProxy {
	    ...
	    @discardableResult
	    func viewWillTransition<M1: Cuckoo.Matchable, M2: Cuckoo.Matchable>(to size: M1, with coordinator: M2) -> Cuckoo.__DoNotUse<(CGSize, UIViewControllerTransitionCoordinator), Void> where M1.MatchedType == CGSize, M2.MatchedType == UIViewControllerTransitionCoordinator {
	        let matchers: [Cuckoo.ParameterMatcher<(CGSize, UIViewControllerTransitionCoordinator)>] = [wrap(matchable: size) { $0.0 }, wrap(matchable: coordinator) { $0.1 }]
...
// MARK: - Mocks generated from file: ComicRating/Modules/ComicHistory/View/ComicHistoryViewInput.swift at 2020-08-28 15:13:56 +0000
 ...
 class MockComicHistoryViewInput: ComicHistoryViewInput, Cuckoo.ProtocolMock {
    ...
    return cuckoo_manager.call("showImageAtIndex(index: Int, image: ComicImage)",
	 ...
	 struct __StubbingProxy_ComicHistoryViewInput: Cuckoo.StubbingProxy {
	    ...
	    func setupInitialState() -> Cuckoo.ProtocolStubNoReturnFunction<()> {
	        let matchers: [Cuckoo.ParameterMatcher<Void>] = []
	        return .init(stub: cuckoo_manager.createStub(for: MockComicHistoryViewInput.self, method: "setupInitialState()", parameterMatchers: matchers))
	    }
	    ...
	    func showComics<M1: Cuckoo.Matchable>(comics: M1) -> Cuckoo.ProtocolStubNoReturnFunction<([ComicForCell])> where M1.MatchedType == [ComicForCell] {
	        ...
	        return .init(stub: cuckoo_manager.createStub(for: MockComicHistoryViewInput.self, method: "showComics(comics: [ComicForCell])", parameterMatchers: matchers))
	    }
	    
	    func showLoadingOnImages() -> Cuckoo.ProtocolStubNoReturnFunction<()> {
	        let matchers: [Cuckoo.ParameterMatcher<Void>] = []
	        return .init(stub: cuckoo_manager.createStub(for: MockComicHistoryViewInput.self, method: "showLoadingOnImages()", parameterMatchers: matchers))
	    }
	    
	    func showImageAtIndex<M1: Cuckoo.Matchable, M2: Cuckoo.Matchable>(index: M1, image: M2) -> Cuckoo.ProtocolStubNoReturnFunction<(Int, ComicImage)> where M1.MatchedType == Int, M2.MatchedType == ComicImage {
	        let matchers: [Cuckoo.ParameterMatcher<(Int, ComicImage)>] = [wrap(matchable: index) { $0.0 }, wrap(matchable: image) { $0.1 }]
	        return .init(stub: cuckoo_manager.createStub(for: MockComicHistoryViewInput.self, method: "showImageAtIndex(index: Int, image: ComicImage)", parameterMatchers: matchers))
	    }
	 ...
	 struct __VerificationProxy_ComicHistoryViewInput: Cuckoo.VerificationProxy {
	    ...
	    @discardableResult
	    func showLoadingOnImages() -> Cuckoo.__DoNotUse<(), Void> {
	        let matchers: [Cuckoo.ParameterMatcher<Void>] = []
	    ...
	    @discardableResult
	    func showImageAtIndex<M1: Cuckoo.Matchable, M2: Cuckoo.Matchable>(index: M1, image: M2) -> Cuckoo.__DoNotUse<(Int, ComicImage), Void> where M1.MatchedType == Int, M2.MatchedType == ComicImage {
	        let matchers: [Cuckoo.ParameterMatcher<(Int, ComicImage)>] = [wrap(matchable: index) { $0.0 }, wrap(matchable: image) { $0.1 }]
...
// MARK: - Mocks generated from file: ComicRating/Modules/ComicHistory/View/ComicHistoryViewOutput.swift at 2020-08-28 15:13:56 +0000
    ...
    return cuckoo_manager.call("viewIsReady()",
	 ...
	 struct __StubbingProxy_ComicHistoryViewOutput: Cuckoo.StubbingProxy {
	    ...
	    func viewIsReady() -> Cuckoo.ProtocolStubNoReturnFunction<()> {
	        let matchers: [Cuckoo.ParameterMatcher<Void>] = []
	        return .init(stub: cuckoo_manager.createStub(for: MockComicHistoryViewOutput.self, method: "viewIsReady()", parameterMatchers: matchers))
	    }
...
// MARK: - Mocks generated from file: ComicRating/Modules/ShowComic/Configurator/ShowComicInitializer.swift at 2020-08-28 15:13:56 +0000
 ...
 class MockShowComicModuleInitializer: ShowComicModuleInitializer, Cuckoo.ClassMock {
    ...
    return cuckoo_manager.call("awakeFromNib()",
	 ...
	 struct __StubbingProxy_ShowComicModuleInitializer: Cuckoo.StubbingProxy {
	    ...
	    var showComicViewController: Cuckoo.ClassToBeStubbedOptionalProperty<MockShowComicModuleInitializer, ShowComicViewController> {
	    ...
	    func awakeFromNib() -> Cuckoo.ClassStubNoReturnFunction<()> {
	        let matchers: [Cuckoo.ParameterMatcher<Void>] = []
	        return .init(stub: cuckoo_manager.createStub(for: MockShowComicModuleInitializer.self, method: "awakeFromNib()", parameterMatchers: matchers))
	    }
	 ...
	 struct __VerificationProxy_ShowComicModuleInitializer: Cuckoo.VerificationProxy {
	    ...
	    var showComicViewController: Cuckoo.VerifyOptionalProperty<ShowComicViewController> {
	        return .init(manager: cuckoo_manager, name: "showComicViewController", callMatcher: callMatcher, sourceLocation: sourceLocation)
	    }
 ...
 class MockShowComicModuleBuilder: ShowComicModuleBuilder, Cuckoo.ClassMock {
    ...
    return cuckoo_manager.call("getViewController() -> ShowComicViewController?",
	 ...
	 struct __StubbingProxy_ShowComicModuleBuilder: Cuckoo.StubbingProxy {
	    ...
	    func getViewController() -> Cuckoo.ClassStubFunction<(), ShowComicViewController?> {
	        let matchers: [Cuckoo.ParameterMatcher<Void>] = []
	        return .init(stub: cuckoo_manager.createStub(for: MockShowComicModuleBuilder.self, method: "getViewController() -> ShowComicViewController?", parameterMatchers: matchers))
	    }
	 ...
	 struct __VerificationProxy_ShowComicModuleBuilder: Cuckoo.VerificationProxy {
	    ...
	    @discardableResult
	    func getViewController() -> Cuckoo.__DoNotUse<(), ShowComicViewController?> {
	        let matchers: [Cuckoo.ParameterMatcher<Void>] = []
...
// MARK: - Mocks generated from file: ComicRating/Modules/ShowComic/Interactor/ShowComicInteractorInput.swift at 2020-08-28 15:13:56 +0000
 ...
 class MockShowComicInteractorInput: ShowComicInteractorInput, Cuckoo.ProtocolMock {
    ...
    return cuckoo_manager.call("comicRated(_: UInt8)",
	 ...
	 struct __StubbingProxy_ShowComicInteractorInput: Cuckoo.StubbingProxy {
	    ...
	    func fetchComic() -> Cuckoo.ProtocolStubNoReturnFunction<()> {
	        let matchers: [Cuckoo.ParameterMatcher<Void>] = []
	        return .init(stub: cuckoo_manager.createStub(for: MockShowComicInteractorInput.self, method: "fetchComic()", parameterMatchers: matchers))
	    }
	    ...
	    func fetchImage<M1: Cuckoo.Matchable>(fromUrl url: M1) -> Cuckoo.ProtocolStubNoReturnFunction<(URL)> where M1.MatchedType == URL {
	        ...
	        return .init(stub: cuckoo_manager.createStub(for: MockShowComicInteractorInput.self, method: "fetchImage(fromUrl: URL)", parameterMatchers: matchers))
	    }
	    ...
	    func comicRated<M1: Cuckoo.Matchable>(_ rating: M1) -> Cuckoo.ProtocolStubNoReturnFunction<(UInt8)> where M1.MatchedType == UInt8 {
	        ...
	        return .init(stub: cuckoo_manager.createStub(for: MockShowComicInteractorInput.self, method: "comicRated(_: UInt8)", parameterMatchers: matchers))
	    }
	 ...
	 struct __VerificationProxy_ShowComicInteractorInput: Cuckoo.VerificationProxy {
	    ...
	    @discardableResult
	    func fetchComic() -> Cuckoo.__DoNotUse<(), Void> {
	        let matchers: [Cuckoo.ParameterMatcher<Void>] = []
...
// MARK: - Mocks generated from file: ComicRating/Modules/ShowComic/Interactor/ShowComicInteractorOutput.swift at 2020-08-28 15:13:56 +0000
    ...
    return cuckoo_manager.call("comicFetchFailed(message: String)",
	 ...
	 struct __StubbingProxy_ShowComicInteractorOutput: Cuckoo.StubbingProxy {
	    ...
	    func comicFetched<M1: Cuckoo.Matchable>(comic: M1) -> Cuckoo.ProtocolStubNoReturnFunction<(Comic)> where M1.MatchedType == Comic {
	        ...
	        return .init(stub: cuckoo_manager.createStub(for: MockShowComicInteractorOutput.self, method: "comicFetched(comic: Comic)", parameterMatchers: matchers))
	    }
	    ...
	    func imageFetched<M1: Cuckoo.Matchable>(imageData: M1) -> Cuckoo.ProtocolStubNoReturnFunction<(Data)> where M1.MatchedType == Data {
	        ...
	        return .init(stub: cuckoo_manager.createStub(for: MockShowComicInteractorOutput.self, method: "imageFetched(imageData: Data)", parameterMatchers: matchers))
	    }
	    ...
	    func comicFetchFailed<M1: Cuckoo.Matchable>(message: M1) -> Cuckoo.ProtocolStubNoReturnFunction<(String)> where M1.MatchedType == String {
	        ...
	        return .init(stub: cuckoo_manager.createStub(for: MockShowComicInteractorOutput.self, method: "comicFetchFailed(message: String)", parameterMatchers: matchers))
	    }
...
// MARK: - Mocks generated from file: ComicRating/Modules/ShowComic/View/ShowComicViewController.swift at 2020-08-28 15:13:56 +0000
...
import UIKit
 ...
 class MockShowComicViewController: ShowComicViewController, Cuckoo.ClassMock {
    ...
    private var __defaultImplStub: ShowComicViewController?
     ...
     override var comicImageView: ResizableImageView! {
        get {
    ...
    return cuckoo_manager.call("nextButtonClicked(_: Any)",
	 ...
	 struct __StubbingProxy_ShowComicViewController: Cuckoo.StubbingProxy {
	    ...
	    var comicImageView: Cuckoo.ClassToBeStubbedOptionalProperty<MockShowComicViewController, ResizableImageView> {
	    ...
	    var loadingIndicator: Cuckoo.ClassToBeStubbedOptionalProperty<MockShowComicViewController, UIActivityIndicatorView> {
	    ...
	    func viewDidLoad() -> Cuckoo.ClassStubNoReturnFunction<()> {
	        let matchers: [Cuckoo.ParameterMatcher<Void>] = []
	        return .init(stub: cuckoo_manager.createStub(for: MockShowComicViewController.self, method: "viewDidLoad()", parameterMatchers: matchers))
	    }
	    
	    func viewWillAppear<M1: Cuckoo.Matchable>(_ animated: M1) -> Cuckoo.ClassStubNoReturnFunction<(Bool)> where M1.MatchedType == Bool {
	        let matchers: [Cuckoo.ParameterMatcher<(Bool)>] = [wrap(matchable: animated) { $0 }]
	        return .init(stub: cuckoo_manager.createStub(for: MockShowComicViewController.self, method: "viewWillAppear(_: Bool)", parameterMatchers: matchers))
	    }
	    ...
	    func nextButtonClicked<M1: Cuckoo.Matchable>(_ parameter0: M1) -> Cuckoo.ClassStubNoReturnFunction<(Any)> where M1.MatchedType == Any {
	        ...
	        return .init(stub: cuckoo_manager.createStub(for: MockShowComicViewController.self, method: "nextButtonClicked(_: Any)", parameterMatchers: matchers))
	    }
	 ...
	 struct __VerificationProxy_ShowComicViewController: Cuckoo.VerificationProxy {
	    ...
	    var comicTitleLabel: Cuckoo.VerifyOptionalProperty<UILabel> {
	        return .init(manager: cuckoo_manager, name: "comicTitleLabel", callMatcher: callMatcher, sourceLocation: sourceLocation)
	    }
	    
	    
	    var comicNumberLabel: Cuckoo.VerifyOptionalProperty<UILabel> {
	        return .init(manager: cuckoo_manager, name: "comicNumberLabel", callMatcher: callMatcher, sourceLocation: sourceLocation)
	    }
	    
	    
	    var comicDateLabel: Cuckoo.VerifyOptionalProperty<UILabel> {
	        return .init(manager: cuckoo_manager, name: "comicDateLabel", callMatcher: callMatcher, sourceLocation: sourceLocation)
	    }
	    
	    
	    var comicImageView: Cuckoo.VerifyOptionalProperty<ResizableImageView> {
	        return .init(manager: cuckoo_manager, name: "comicImageView", callMatcher: callMatcher, sourceLocation: sourceLocation)
	    }
	    
	    
	    var nextButton: Cuckoo.VerifyOptionalProperty<UIButton> {
	        return .init(manager: cuckoo_manager, name: "nextButton", callMatcher: callMatcher, sourceLocation: sourceLocation)
	    }
	    
	    
	    var ratingView: Cuckoo.VerifyOptionalProperty<RatingView> {
	        return .init(manager: cuckoo_manager, name: "ratingView", callMatcher: callMatcher, sourceLocation: sourceLocation)
	    }
	    
	    
	    var loadingIndicator: Cuckoo.VerifyOptionalProperty<UIActivityIndicatorView> {
	        return .init(manager: cuckoo_manager, name: "loadingIndicator", callMatcher: callMatcher, sourceLocation: sourceLocation)
	    }
	    
	    
	    var imageViewHeight: Cuckoo.VerifyOptionalProperty<NSLayoutConstraint> {
	        return .init(manager: cuckoo_manager, name: "imageViewHeight", callMatcher: callMatcher, sourceLocation: sourceLocation)
	    }
	    
	    
	    var imageViewWidth: Cuckoo.VerifyOptionalProperty<NSLayoutConstraint> {
	        return .init(manager: cuckoo_manager, name: "imageViewWidth", callMatcher: callMatcher, sourceLocation: sourceLocation)
	    }
 ...
 class ShowComicViewControllerStub: ShowComicViewController {
     ...
     override var comicImageView: ResizableImageView! {
        get {
            return DefaultValueRegistry.defaultValue(for: (ResizableImageView?).self)
        }
...
// MARK: - Mocks generated from file: ComicRating/Modules/ShowComic/View/ShowComicViewInput.swift at 2020-08-28 15:13:56 +0000
 ...
 class MockShowComicViewInput: ShowComicViewInput, Cuckoo.ProtocolMock {
    ...
    return cuckoo_manager.call("showOkAlertMessage(title: String, message: String)",
	 ...
	 struct __StubbingProxy_ShowComicViewInput: Cuckoo.StubbingProxy {
	    ...
	    func setupInitialState() -> Cuckoo.ProtocolStubNoReturnFunction<()> {
	        let matchers: [Cuckoo.ParameterMatcher<Void>] = []
	        return .init(stub: cuckoo_manager.createStub(for: MockShowComicViewInput.self, method: "setupInitialState()", parameterMatchers: matchers))
	    }
	    ...
	    func showComic<M1: Cuckoo.Matchable>(comic: M1) -> Cuckoo.ProtocolStubNoReturnFunction<(UpcomingComic)> where M1.MatchedType == UpcomingComic {
	        ...
	        return .init(stub: cuckoo_manager.createStub(for: MockShowComicViewInput.self, method: "showComic(comic: UpcomingComic)", parameterMatchers: matchers))
	    }
	    
	    func showImage<M1: Cuckoo.Matchable>(imageData: M1) -> Cuckoo.ProtocolStubNoReturnFunction<(Data)> where M1.MatchedType == Data {
	        let matchers: [Cuckoo.ParameterMatcher<(Data)>] = [wrap(matchable: imageData) { $0 }]
	        return .init(stub: cuckoo_manager.createStub(for: MockShowComicViewInput.self, method: "showImage(imageData: Data)", parameterMatchers: matchers))
	    }
	    
	    func resetRating() -> Cuckoo.ProtocolStubNoReturnFunction<()> {
	        let matchers: [Cuckoo.ParameterMatcher<Void>] = []
	        return .init(stub: cuckoo_manager.createStub(for: MockShowComicViewInput.self, method: "resetRating()", parameterMatchers: matchers))
	    }
	    ...
	    func showLoadingContent<M1: Cuckoo.Matchable>(onElement element: M1) -> Cuckoo.ProtocolStubNoReturnFunction<(Element)> where M1.MatchedType == Element {
	        ...
	        return .init(stub: cuckoo_manager.createStub(for: MockShowComicViewInput.self, method: "showLoadingContent(onElement: Element)", parameterMatchers: matchers))
	    }
	    ...
	    func stopLoadingContent<M1: Cuckoo.Matchable>(onElement element: M1) -> Cuckoo.ProtocolStubNoReturnFunction<(Element)> where M1.MatchedType == Element {
	        let matchers: [Cuckoo.ParameterMatcher<(Element)>] = [wrap(matchable: element) { $0 }]
	        return .init(stub: cuckoo_manager.createStub(for: MockShowComicViewInput.self, method: "stopLoadingContent(onElement: Element)", parameterMatchers: matchers))
	    }
	    
	    func showOkAlertMessage<M1: Cuckoo.Matchable, M2: Cuckoo.Matchable>(title: M1, message: M2) -> Cuckoo.ProtocolStubNoReturnFunction<(String, String)> where M1.MatchedType == String, M2.MatchedType == String {
	        let matchers: [Cuckoo.ParameterMatcher<(String, String)>] = [wrap(matchable: title) { $0.0 }, wrap(matchable: message) { $0.1 }]
	        return .init(stub: cuckoo_manager.createStub(for: MockShowComicViewInput.self, method: "showOkAlertMessage(title: String, message: String)", parameterMatchers: matchers))
	    }
	 ...
	 struct __VerificationProxy_ShowComicViewInput: Cuckoo.VerificationProxy {
	    ...
	    @discardableResult
	    func resetRating() -> Cuckoo.__DoNotUse<(), Void> {
	        let matchers: [Cuckoo.ParameterMatcher<Void>] = []
	    ...
	    @discardableResult
	    func showOkAlertMessage<M1: Cuckoo.Matchable, M2: Cuckoo.Matchable>(title: M1, message: M2) -> Cuckoo.__DoNotUse<(String, String), Void> where M1.MatchedType == String, M2.MatchedType == String {
	        let matchers: [Cuckoo.ParameterMatcher<(String, String)>] = [wrap(matchable: title) { $0.0 }, wrap(matchable: message) { $0.1 }]
...
// MARK: - Mocks generated from file: ComicRating/Modules/ShowComic/View/ShowComicViewOutput.swift at 2020-08-28 15:13:56 +0000
 ...
 class MockShowComicViewOutput: ShowComicViewOutput, Cuckoo.ProtocolMock {
    ...
    return cuckoo_manager.call("comicRated(rating: UInt8)",
	 ...
	 struct __StubbingProxy_ShowComicViewOutput: Cuckoo.StubbingProxy {
	    ...
	    func viewIsReady() -> Cuckoo.ProtocolStubNoReturnFunction<()> {
	        let matchers: [Cuckoo.ParameterMatcher<Void>] = []
	        return .init(stub: cuckoo_manager.createStub(for: MockShowComicViewOutput.self, method: "viewIsReady()", parameterMatchers: matchers))
	    }
	    
	    func nextButtonClicked() -> Cuckoo.ProtocolStubNoReturnFunction<()> {
	        let matchers: [Cuckoo.ParameterMatcher<Void>] = []
	        return .init(stub: cuckoo_manager.createStub(for: MockShowComicViewOutput.self, method: "nextButtonClicked()", parameterMatchers: matchers))
	    }
	    
	    func comicRated<M1: Cuckoo.Matchable>(rating: M1) -> Cuckoo.ProtocolStubNoReturnFunction<(UInt8)> where M1.MatchedType == UInt8 {
	        let matchers: [Cuckoo.ParameterMatcher<(UInt8)>] = [wrap(matchable: rating) { $0 }]
	        return .init(stub: cuckoo_manager.createStub(for: MockShowComicViewOutput.self, method: "comicRated(rating: UInt8)", parameterMatchers: matchers))
	    }
	 ...
	 struct __VerificationProxy_ShowComicViewOutput: Cuckoo.VerificationProxy {
	    ...
	    @discardableResult
	    func nextButtonClicked() -> Cuckoo.__DoNotUse<(), Void> {
	        let matchers: [Cuckoo.ParameterMatcher<Void>] = []
...
// MARK: - Mocks generated from file: ComicRating/Modules/TabBar/Interactor/TabBarInteractorInput.swift at 2020-08-28 15:13:56 +0000
...
// MARK: - Mocks generated from file: ComicRating/Modules/TabBar/Router/TabBarRouterInput.swift at 2020-08-28 15:13:56 +0000
 ...
 class MockTabBarRouterInput: TabBarRouterInput, Cuckoo.ProtocolMock {
    ...
    return cuckoo_manager.call("getTabSections() -> TabSections?",
	 ...
	 struct __StubbingProxy_TabBarRouterInput: Cuckoo.StubbingProxy {
	    ...
	    func getTabSections() -> Cuckoo.ProtocolStubFunction<(), TabSections?> {
	        let matchers: [Cuckoo.ParameterMatcher<Void>] = []
	        return .init(stub: cuckoo_manager.createStub(for: MockTabBarRouterInput.self, method: "getTabSections() -> TabSections?", parameterMatchers: matchers))
	    }
	 ...
	 struct __VerificationProxy_TabBarRouterInput: Cuckoo.VerificationProxy {
	    ...
	    @discardableResult
	    func getTabSections() -> Cuckoo.__DoNotUse<(), TabSections?> {
	        let matchers: [Cuckoo.ParameterMatcher<Void>] = []
...
// MARK: - Mocks generated from file: ComicRating/Modules/TabBar/View/TabBarViewInput.swift at 2020-08-28 15:13:56 +0000
 ...
 class MockTabBarViewInput: TabBarViewInput, Cuckoo.ProtocolMock {
    ...
    return cuckoo_manager.call("setup(viewControllers: [UIViewController])",
	 ...
	 struct __StubbingProxy_TabBarViewInput: Cuckoo.StubbingProxy {
	    ...
	    func setup<M1: Cuckoo.Matchable>(viewControllers: M1) -> Cuckoo.ProtocolStubNoReturnFunction<([UIViewController])> where M1.MatchedType == [UIViewController] {
	        let matchers: [Cuckoo.ParameterMatcher<([UIViewController])>] = [wrap(matchable: viewControllers) { $0 }]
	        return .init(stub: cuckoo_manager.createStub(for: MockTabBarViewInput.self, method: "setup(viewControllers: [UIViewController])", parameterMatchers: matchers))
	    }
	 ...
	 struct __VerificationProxy_TabBarViewInput: Cuckoo.VerificationProxy {
	    ...
	    @discardableResult
	    func setup<M1: Cuckoo.Matchable>(viewControllers: M1) -> Cuckoo.__DoNotUse<([UIViewController]), Void> where M1.MatchedType == [UIViewController] {
	        let matchers: [Cuckoo.ParameterMatcher<([UIViewController])>] = [wrap(matchable: viewControllers) { $0 }]
...
// MARK: - Mocks generated from file: ComicRating/Modules/TabBar/View/TabBarViewOutput.swift at 2020-08-28 15:13:56 +0000
 ...
 class MockTabBarViewOutput: TabBarViewOutput, Cuckoo.ProtocolMock {
    ...
    return cuckoo_manager.call("viewIsReady()",
	 ...
	 struct __StubbingProxy_TabBarViewOutput: Cuckoo.StubbingProxy {
	    ...
	    func viewIsReady() -> Cuckoo.ProtocolStubNoReturnFunction<()> {
	        let matchers: [Cuckoo.ParameterMatcher<Void>] = []
	        return .init(stub: cuckoo_manager.createStub(for: MockTabBarViewOutput.self, method: "viewIsReady()", parameterMatchers: matchers))
	    }
...
// MARK: - Mocks generated from file: ComicRating/Services/Api/ComicApiService.swift at 2020-08-28 15:13:56 +0000
 ...
 class MockComicApiService: ComicApiService, Cuckoo.ClassMock {
    ...
    return cuckoo_manager.call("getLastComic() -> Promise<Comic>",
	 ...
	 struct __StubbingProxy_ComicApiService: Cuckoo.StubbingProxy {
	    ...
	    func getComic<M1: Cuckoo.Matchable, M2: Cuckoo.Matchable>(id: M1, completion: M2) -> Cuckoo.ClassStubNoReturnFunction<(Int, ((Comic?) -> Void))> where M1.MatchedType == Int, M2.MatchedType == ((Comic?) -> Void) {
	        let matchers: [Cuckoo.ParameterMatcher<(Int, ((Comic?) -> Void))>] = [wrap(matchable: id) { $0.0 }, wrap(matchable: completion) { $0.1 }]
	        return .init(stub: cuckoo_manager.createStub(for: MockComicApiService.self, method: "getComic(id: Int, completion: @escaping ((Comic?) -> Void))", parameterMatchers: matchers))
	    }
	    ...
	    func getLastComic<M1: Cuckoo.Matchable>(completion: M1) -> Cuckoo.ClassStubNoReturnFunction<(((Comic?) -> Void))> where M1.MatchedType == ((Comic?) -> Void) {
	        ...
	        return .init(stub: cuckoo_manager.createStub(for: MockComicApiService.self, method: "getLastComic(completion: @escaping ((Comic?) -> Void))", parameterMatchers: matchers))
	    }
	    
	    func getComic<M1: Cuckoo.Matchable>(id: M1) -> Cuckoo.ClassStubFunction<(Int), Promise<Comic>> where M1.MatchedType == Int {
	        let matchers: [Cuckoo.ParameterMatcher<(Int)>] = [wrap(matchable: id) { $0 }]
	        return .init(stub: cuckoo_manager.createStub(for: MockComicApiService.self, method: "getComic(id: Int) -> Promise<Comic>", parameterMatchers: matchers))
	    }
	    
	    func getLastComic() -> Cuckoo.ClassStubFunction<(), Promise<Comic>> {
	        let matchers: [Cuckoo.ParameterMatcher<Void>] = []
	        return .init(stub: cuckoo_manager.createStub(for: MockComicApiService.self, method: "getLastComic() -> Promise<Comic>", parameterMatchers: matchers))
	    }
	 ...
	 struct __VerificationProxy_ComicApiService: Cuckoo.VerificationProxy {
	    ...
	    var httpService: Cuckoo.VerifyProperty<HttpServiceInterface> {
	        return .init(manager: cuckoo_manager, name: "httpService", callMatcher: callMatcher, sourceLocation: sourceLocation)
	    }
	    
	
	    
	    @discardableResult
	    func getComic<M1: Cuckoo.Matchable, M2: Cuckoo.Matchable>(id: M1, completion: M2) -> Cuckoo.__DoNotUse<(Int, ((Comic?) -> Void)), Void> where M1.MatchedType == Int, M2.MatchedType == ((Comic?) -> Void) {
	        let matchers: [Cuckoo.ParameterMatcher<(Int, ((Comic?) -> Void))>] = [wrap(matchable: id) { $0.0 }, wrap(matchable: completion) { $0.1 }]
	    ...
	    @discardableResult
	    func getLastComic() -> Cuckoo.__DoNotUse<(), Promise<Comic>> {
	        let matchers: [Cuckoo.ParameterMatcher<Void>] = []
...
// MARK: - Mocks generated from file: ComicRating/Services/Api/ComicApiServiceInterface.swift at 2020-08-28 15:13:56 +0000
 ...
 class MockComicApiServiceInterface: ComicApiServiceInterface, Cuckoo.ProtocolMock {
    ...
    return cuckoo_manager.call("getLastComic() -> Promise<Comic>",
	 ...
	 struct __StubbingProxy_ComicApiServiceInterface: Cuckoo.StubbingProxy {
	    ...
	    func getComic<M1: Cuckoo.Matchable, M2: Cuckoo.Matchable>(id: M1, completion: M2) -> Cuckoo.ProtocolStubNoReturnFunction<(Int, ((Comic?) -> Void))> where M1.MatchedType == Int, M2.MatchedType == ((Comic?) -> Void) {
	        let matchers: [Cuckoo.ParameterMatcher<(Int, ((Comic?) -> Void))>] = [wrap(matchable: id) { $0.0 }, wrap(matchable: completion) { $0.1 }]
	        return .init(stub: cuckoo_manager.createStub(for: MockComicApiServiceInterface.self, method: "getComic(id: Int, completion: @escaping ((Comic?) -> Void))", parameterMatchers: matchers))
	    }
	    ...
	    func getLastComic<M1: Cuckoo.Matchable>(completion: M1) -> Cuckoo.ProtocolStubNoReturnFunction<(((Comic?) -> Void))> where M1.MatchedType == ((Comic?) -> Void) {
	        let matchers: [Cuckoo.ParameterMatcher<(((Comic?) -> Void))>] = [wrap(matchable: completion) { $0 }]
	        return .init(stub: cuckoo_manager.createStub(for: MockComicApiServiceInterface.self, method: "getLastComic(completion: @escaping ((Comic?) -> Void))", parameterMatchers: matchers))
	    }
	    
	    func getComic<M1: Cuckoo.Matchable>(id: M1) -> Cuckoo.ProtocolStubFunction<(Int), Promise<Comic>> where M1.MatchedType == Int {
	        let matchers: [Cuckoo.ParameterMatcher<(Int)>] = [wrap(matchable: id) { $0 }]
	        return .init(stub: cuckoo_manager.createStub(for: MockComicApiServiceInterface.self, method: "getComic(id: Int) -> Promise<Comic>", parameterMatchers: matchers))
	    }
	    
	    func getLastComic() -> Cuckoo.ProtocolStubFunction<(), Promise<Comic>> {
	        let matchers: [Cuckoo.ParameterMatcher<Void>] = []
	        return .init(stub: cuckoo_manager.createStub(for: MockComicApiServiceInterface.self, method: "getLastComic() -> Promise<Comic>", parameterMatchers: matchers))
	    }
...
// MARK: - Mocks generated from file: ComicRating/Services/Api/ImageDownloaderService.swift at 2020-08-28 15:13:56 +0000
    ...
    return cuckoo_manager.call("fetchImage(fromUrl: URL) -> Promise<Data>",
	 ...
	 struct __StubbingProxy_ImageDownloaderService: Cuckoo.StubbingProxy {
	    ...
	    func fetchImage<M1: Cuckoo.Matchable>(fromUrl url: M1) -> Cuckoo.ClassStubFunction<(URL), Promise<Data>> where M1.MatchedType == URL {
	        let matchers: [Cuckoo.ParameterMatcher<(URL)>] = [wrap(matchable: url) { $0 }]
	        return .init(stub: cuckoo_manager.createStub(for: MockImageDownloaderService.self, method: "fetchImage(fromUrl: URL) -> Promise<Data>", parameterMatchers: matchers))
	    }
...
// MARK: - Mocks generated from file: ComicRating/Services/Api/ImageDownloaderServiceInterface.swift at 2020-08-28 15:13:56 +0000
    ...
    return cuckoo_manager.call("fetchImage(fromUrl: URL) -> Promise<Data>",
	 ...
	 struct __StubbingProxy_ImageDownloaderServiceInterface: Cuckoo.StubbingProxy {
	    ...
	    func fetchImage<M1: Cuckoo.Matchable>(fromUrl url: M1) -> Cuckoo.ProtocolStubFunction<(URL), Promise<Data>> where M1.MatchedType == URL {
	        let matchers: [Cuckoo.ParameterMatcher<(URL)>] = [wrap(matchable: url) { $0 }]
	        return .init(stub: cuckoo_manager.createStub(for: MockImageDownloaderServiceInterface.self, method: "fetchImage(fromUrl: URL) -> Promise<Data>", parameterMatchers: matchers))
	    }
...
// MARK: - Mocks generated from file: ComicRating/Services/Storage/ComicStorageService.swift at 2020-08-28 15:13:56 +0000
    ...
    return cuckoo_manager.call("getComics() -> [Comic]",
	 ...
	 struct __StubbingProxy_ComicStorageService: Cuckoo.StubbingProxy {
	    ...
	    func upsertComic<M1: Cuckoo.Matchable>(comic: M1) -> Cuckoo.ClassStubNoReturnFunction<(Comic)> where M1.MatchedType == Comic {
	        let matchers: [Cuckoo.ParameterMatcher<(Comic)>] = [wrap(matchable: comic) { $0 }]
	        return .init(stub: cuckoo_manager.createStub(for: MockComicStorageService.self, method: "upsertComic(comic: Comic)", parameterMatchers: matchers))
	    }
	    
	    func getComics() -> Cuckoo.ClassStubFunction<(), [Comic]> {
	        let matchers: [Cuckoo.ParameterMatcher<Void>] = []
	        return .init(stub: cuckoo_manager.createStub(for: MockComicStorageService.self, method: "getComics() -> [Comic]", parameterMatchers: matchers))
	    }
	 ...
	 struct __VerificationProxy_ComicStorageService: Cuckoo.VerificationProxy {
	    ...
	    @discardableResult
	    func getComics() -> Cuckoo.__DoNotUse<(), [Comic]> {
	        let matchers: [Cuckoo.ParameterMatcher<Void>] = []
...
// MARK: - Mocks generated from file: ComicRating/Services/Storage/ComicStorageServiceInterface.swift at 2020-08-28 15:13:56 +0000
    ...
    return cuckoo_manager.call("getComics() -> [Comic]",
	 ...
	 struct __StubbingProxy_ComicStorageServiceInterface: Cuckoo.StubbingProxy {
	    ...
	    func upsertComic<M1: Cuckoo.Matchable>(comic: M1) -> Cuckoo.ProtocolStubNoReturnFunction<(Comic)> where M1.MatchedType == Comic {
	        let matchers: [Cuckoo.ParameterMatcher<(Comic)>] = [wrap(matchable: comic) { $0 }]
	        return .init(stub: cuckoo_manager.createStub(for: MockComicStorageServiceInterface.self, method: "upsertComic(comic: Comic)", parameterMatchers: matchers))
	    }
	    
	    func getComics() -> Cuckoo.ProtocolStubFunction<(), [Comic]> {
	        let matchers: [Cuckoo.ParameterMatcher<Void>] = []
	        return .init(stub: cuckoo_manager.createStub(for: MockComicStorageServiceInterface.self, method: "getComics() -> [Comic]", parameterMatchers: matchers))
	    }
